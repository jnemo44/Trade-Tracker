...
In addition to standard HTTP errors the API will also raise an error for failing to validate a request to a specific endpoint.
```
{
  "error": 401,
...
```
The following codes will be returned for an issue with authentication.
